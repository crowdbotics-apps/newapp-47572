"""
Django settings for newapp_47572 project.
...
ROOT_URLCONF = 'newapp_47572.urls'
...
WSGI_APPLICATION = 'newapp_47572.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newapp_47572 API",
    "DESCRIPTION": "API documentation for newapp_47572 App",
    "VERSION": "v1",
}
